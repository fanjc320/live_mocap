...
def main():
    ...
    # fjc = moving_least_square_numpy(x, v, np.ndarray(0,1,1,1,0))
    # return
...
#https://blog.csdn.net/dreliveam/article/details/111666235
# 綜合这篇来看
# https://blog.csdn.net/baidu_38127162/article/details/82380914?depth_1-utm_source=distribute.pc_relevant_right.none-task&utm_source=distribute.pc_relevant_right.none-task
# 为什么最后公式里没有n，因为这个公式是针对每一个n的,n中的每个都会被公式计算一次

# https://zhuanlan.zhihu.com/p/412459069
# 为什么(GA-Y)T(GA-Y)？？？
